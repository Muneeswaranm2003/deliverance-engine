      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          <div className="relative glass rounded-2xl border border-border/50 shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border/50 bg-background/40">
              ...
              <div className="flex-1 flex justify-center">
                <div className="px-3 py-1 rounded-md bg-background/60 border border-border/50 text-xs text-muted-foreground font-mono">
            ...
            {/* Dashboard body */}
            <div className="p-6 bg-gradient-to-br from-background/60 to-background/20">
              {/* Header */}
              <div className="flex items-center justify-between mb-6">
                <div className="text-left">
                  <h3 className="font-display font-bold text-lg">Dashboard</h3>
                  <p className="text-xs text-muted-foreground">Good afternoon, welcome back</p>
                </div>
              ...
              <div className="grid grid-cols-5 gap-3">
                <div className="col-span-3 glass rounded-xl p-4 text-left">
                ...
                <div className="col-span-2 glass rounded-xl p-4 text-left">
          ...
          <motion.div
            ...
            className="hidden md:flex absolute -left-6 top-1/3 glass rounded-xl p-3 items-center gap-2 shadow-xl animate-float"
          >
          ...
          <motion.div
            ...
            className="hidden md:flex absolute -right-6 bottom-1/4 glass rounded-xl p-3 items-center gap-2 shadow-xl animate-float"
